                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="student.php"><i class="menu-icon icon-user"></i>Manage Users </a>
                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Name/Email of Student" class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from lms.user where (Email='$s' or Username like '%$s%') and Role<>'Admin'";
                                        }
                                    else
